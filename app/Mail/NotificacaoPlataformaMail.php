...
class NotificacaoPlataformaMail extends Mailable
{
    ...
    public function __construct(
        ...
        public ?string $botaoTexto = null,
        public ?string $botaoUrl = null,
    ) {}
    ...
    public function content(): Content
    {
        ...
        return new Content(
            ...
            with: [
                ...
                'botaoTexto' => $this->botaoTexto,
                'botaoUrl' => $this->botaoUrl,
