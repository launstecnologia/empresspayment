...
@section('title', 'Pesquisar CNPJ/CPF')
...
<div class="mx-auto max-w-2xl space-y-6">
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="mb-6">
            <h1 class="text-xl font-bold text-gray-800">Pesquisar CNPJ/CPF</h1>
            <p class="mt-1 text-sm text-gray-500">
                Consulta na Força de Vendas PagBank se o documento já possui cadastro ou pode ser incluído na plataforma.
            </p>
        </div>
        ...
        @else
            <form id="form-consulta-documento" class="space-y-4">
                ...
                >
                    ...
                    <span>Consultar no PagBank FV</span>
                </button>
            </form>

            <div id="consulta-loading" class="mt-6 hidden rounded-lg border border-blue-100 bg-blue-50 p-4">
                <div class="flex items-start gap-3">
                    <i class="fa-solid fa-spinner fa-spin mt-0.5 text-blue-600"></i>
                    <div>
                        <p class="text-sm font-semibold text-blue-800">Consultando documento...</p>
                        <p id="consulta-etapa" class="mt-1 text-xs text-blue-700">Aguardando início</p>
                        <p class="mt-2 text-xs text-blue-600">Isso pode levar até 1 minuto (login no portal FV).</p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const etapa = document.getElementById('consulta-etapa');
    ...
    form.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            etapa.textContent = 'Consulta iniciada...';
